        ...
        <nav class="navigation navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{url('/')}}/ummah/assets/images/logo.png" alt="logo"></a>
                </div>
                ...
                <div class="cart-search-contact">
                    <div class="btns">
                        <a href="contact.html" class="theme-btn">{{trans('admin.login')}}</a>
                        <a href="contact.html" class="theme-btn">{{trans('admin.sign_up')}}</a>
                    </div>
                </div>
    ...
    <section class="hero hero-style-2">
        <div class="hero-slider">
            <div class="slide">
                    ...
                    <div class="row">
                        <div class="col col-lg-8 col-md-7 slide-caption">
                            ...
                            <div class="slide-title">
                                <h2>Read! In the Name of your <br> Lord, Who has created</h2>
                            </div>
                            <div class="slide-subtitle">
                                <p>We are the best Educational Organization.Let’s know about Islam <br> And the holy Quran!</p>
                            </div>
                            <div class="btns">
                ...
                <div class="right-vec">
                    <img src="{{url('/')}}/ummah/assets/images/slider/img-3.png" alt="">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="wpo-about-img-3">
                            <img src="{{url('/')}}/ummah/assets/images/about3.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-lg-4">
                        <div class="service-img">
                            <img src="{{url('/')}}/ummah/assets/images/service/img-1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="service-wrap-s2">
                <div class="row">
                    <div class="col-lg-6 col-md-4">
                        <div class="service-img">
                            <img src="{{url('/')}}/ummah/assets/images/service/img-2.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-8">
                        <div class="service-item">
        ...
        <div class="fluid-container">
            <div class="row-grid">
                <div class="grid">
                    <div class="pilars-item">
                        <div class="pilarts-img">
                            <img src="{{url('/')}}/ummah/assets/images/pilars/img-1.png" alt="">
                        </div>
                ...
                <div class="grid">
                    <div class="pilars-item">
                        <div class="pilarts-img">
                            <img src="{{url('/')}}/ummah/assets/images/pilars/img-2.png" alt="">
                        </div>
                        <div class="pilars-text">
                            <h2>Salah</h2>
                        </div>
                ...
                <div class="grid">
                    <div class="pilars-item">
                        <div class="pilarts-img">
                            <img src="{{url('/')}}/ummah/assets/images/pilars/img-4.png" alt="">
                        </div>
                        <div class="pilars-text">
                            <h2>Sawm</h2>
                        </div>
                ...
                <div class="grid">
                    <div class="pilars-item">
                        <div class="pilarts-img">
                            <img src="{{url('/')}}/ummah/assets/images/pilars/img-5.png" alt="">
                        </div>
                        <div class="pilars-text">
                            <h2>Zakah</h2>
                        </div>
                ...
                <div class="grid">
                    <div class="pilars-item">
                        <div class="pilarts-img">
                            <img src="{{url('/')}}/ummah/assets/images/pilars/img-6.png" alt="">
                        </div>
                        <div class="pilars-text">
                            <h2>Hajj</h2>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-12 custom-grid">
                    <div class="wpo-event-item">
                        <div class="wpo-event-img">
                            <img src="{{url('/')}}/ummah/assets/images/event/img-1.jpg" alt="">
                ...
                <div class="col-md-6 col-sm-12 col-12 custom-grid">
                    <div class="wpo-event-item">
                        <div class="wpo-event-img">
                            <img src="{{url('/')}}/ummah/assets/images/event/img-2.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-12 custom-grid">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{url('/')}}/ummah/assets/images/blog/img-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 custom-grid">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{url('/')}}/ummah/assets/images/blog/img-2.jpg" alt="">
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-lg-4 col-sm-6 col-12 custom-grid">
                    <div class="blog-item b-0">
                        <div class="blog-img">
                            <img src="{{url('/')}}/ummah/assets/images/blog/img-3.jpg" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="blog-single.html">Salat is the best exercise for body fitness</a></h3>
                            <ul class="post-meta">
