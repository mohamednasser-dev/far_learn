                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-lg-center">{{trans('s_admin.nav_job_name')}}</th>
                                <th class="text-lg-center">{{trans('admin.active')}}</th>
                                <th class="text-lg-center">{{trans('s_admin.my_requests')}}</th>
                                    ...
                                    @if($user->is_new == 'y')
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="{{route('user.accept',$user->id)}}">{{trans('s_admin.accept')}}</a>
                                            <a class="dropdown-item"
