...
@section('title')
    <div class="d-flex align-items-center flex-wrap mr-2">
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{trans('s_admin.nav_come_out_reports')}}</h5>
...
@section('content')
    ...
    <div class="card card-custom example example-compact">
        <!--begin::Form-->
        <form class="form" method="get" action="{{route('reports.teacher.Achievement.search')}}">
            <div class="card-body">
            ...
            buttons: [
                {
                    ...
                    customize: function (win) {
                        $(win.document.body)
                            ...
                            '                                    <td style="text-align: right"><p>عنوان التقرير : {{trans('s_admin.nav_come_out_reports')}}</p>' +
