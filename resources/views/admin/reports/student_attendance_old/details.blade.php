    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('reports.attendance')}}" class="text-muted">{{trans('s_admin.nav_teachers_reports')}}</a>
            </li>
            <li class="breadcrumb-item">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                <div class="card-body">
                    <div class="card-title"> <h4> {{trans('s_admin.student_info')}} </h4> </div>
                    <div class="form-group row mt-3">
                        <div class="col-lg-2">
                        <h4>{{trans('s_admin.student_name')}}</h4>
                        </div>
                        <div class="col-lg-2">
                            <h4>{{$student->first_name_ar}} &nbsp; {{$student->mid_name_ar}}  &nbsp; {{$student->last_name_ar}}</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <form action="{{route('reports.attendance.search.period',$student->id)}}" method="get">
                        @csrf
                        <div class="form-group row mt-3">
    ...
    <div class="row">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="card-title">
                        <h4>{{trans('s_admin.attendance_days')}} ( {{count($attendance_data)}} )</h4>
                    </div>
        ...
        <div class="col-lg-6">
            <div class="card card-custom">
                <div class="card-body">
                    <div class="card-title">
                        <h4>{{trans('s_admin.absence_days')}} ( {{count($absence_data)}} )</h4>
                    </div>
