    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                {{--                @can('add')--}}
                <a data-toggle="modal" data-target="#exampleModalLong" class="btn btn-success px-6 font-weight-bold"><i
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                ...
                <tr>
                    ...
                    <th title="Field #2">{{trans('s_admin.active')}}</th>
                    ...
                    <tr>
                            ...
                            <span class="switch switch-icon">
                                <label>
                                    <input onchange="update_active(this)" value="{{ $row->id }}"
                                           type="checkbox" <?php if ($row->deleted == '0') echo "checked";?>>
                                    <span></span>
                                </label>
                            </span>
                        </td>
                        <td>
                            <a class="btn btn-icon btn-primary btn-circle btn-sm mr-2"
                               ...
                               data-name_en="{{$row->name_en}}" id="edit"
...
@section('scripts')
    ...
    <script type="text/javascript">
        function update_active(el) {
            ...
            $.post('{{ route('job_name.change_status') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function (data) {
