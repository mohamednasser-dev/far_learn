...
@section('title')
    <div class="d-flex align-items-center flex-wrap mr-2">
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{trans('s_admin.cities')}}</h5>
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                ...
                <tr>
                    ...
                    <th title="Field #2">{{trans('s_admin.district_S')}}</th>
                ...
                @foreach($data as $key => $row)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('district.show',['id'=>$row->id,'country_id'=>$country_id,'zone_id'=>$id])}}" class="btn btn-dark mr-2">{{trans('s_admin.district_S')}}</a>
                        </td>
                        <td>
                            ...
                            <a onclick="return confirm('{{trans('s_admin.are_y_sure_delete')}}')" class="btn btn-icon btn-danger btn-circle btn-sm mr-2"
                               href="{{route('cities.delete',$row->id)}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="hidden" required class="form-control"  name="zone_id" value="{{$id}}">
    ...
    <div class="modal fade" id="edit_model" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open( ['route' =>'cities.update','method'=>'post', 'files'=>'true'] ) }}
