...
@section('title')
    <div class="d-flex align-items-center flex-wrap mr-2">
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{trans('s_admin.add_absence_attendance')}}</h5>
...
@endsection
@section('content')
    @if(auth()->user()->role_id == 8 || auth()->user()->role_id == 2 )
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="card card-custom wave wave-success">
                <div class="card-body">
                    <div class="d-flex align-items-center p-5">
                        ...
                        <div class="d-flex flex-column">
                            <a href="{{route('absence.multi.teacher','mqraa')}}" class="text-dark text-hover-primary font-weight-bold font-size-h3 mb-3">
    ...
    @if(settings()->show_mogmaa_dorr == '1')
        @if(auth()->user()->role_id == 3 || auth()->user()->role_id == 6 || auth()->user()->role_id == 2 )
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <div class="card card-custom wave wave-primary mb-8 mb-lg-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                <a href="{{route('absence.colleges',['type'=>'mogmaa','college_type'=>'college'])}}" class="text-dark text-hover-primary font-weight-bold font-size-h3 mb-3">
        ...
        <br>
        @endif
        @if(auth()->user()->role_id == 5 || auth()->user()->role_id == 7 || auth()->user()->role_id == 2 )
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <div class="card card-custom wave wave-danger mb-8 mb-lg-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                <a href="{{route('absence.colleges',['type'=>'dorr','college_type'=>'dorr'])}}" class="text-dark text-hover-primary font-weight-bold font-size-h3 mb-3">
                                    {{trans('s_admin.dorrs')}}
                                </a>
                            </div>
                        </div>
