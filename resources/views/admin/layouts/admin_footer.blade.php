...
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="http://uramit.com/" target="_blank" class="text-dark-75 text-hover-primary">URAM</a>
        </div>
        <!--end::Copyright-->
    </div>
    <!--end::Container-->
...
<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
    <!--begin::Item-->
    <li class="nav-item mb-2" id="kt_demo_panel_toggle" data-toggle="tooltip" title="اعدادات الالوان" data-placement="right">
        ...
        <form method="GET">
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                <div class="form-group">
                    <div class="col-12">
                        <input class="form-control" type="color" name="coloradmin" @if (isset($_GET['coloradmin'])) value="{{ session('coloradmin')}}" @else value="#563d7c" @endif id="example-color-input" />
                    </div>
                </div>
            </div>
            <!--end::Wrapper-->
            ...
            <div class="offcanvas-footer">
                <button type="submit" class="btn btn-block btn-danger btn-shadow font-weight-bolder text-uppercase">حفظ</button>
            </div>
