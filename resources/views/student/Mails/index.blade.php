    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="card-body px-5">
                            ...
                            <div
                                ...
                                <div class="navi-item my-2">
                                    <a href="{{route('student.inbox.in')}}"
                                       class="navi-link @if(Route::current()->getName() == 'student.inbox.in' ) active @endif">
                                ...
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="{{route('student.inbox.out')}}"
                                       class="navi-link @if(Route::current()->getName() == 'student.inbox.out' ) active @endif">
															<span class="navi-icon mr-4">
																<span class="svg-icon svg-icon-lg">
                ...
                @if(Route::current()->getName() == 'student.inbox.in')
                    @include('student.Mails.inbox')
                @elseif(Route::current()->getName() == 'student.inbox.out')
                    @include('student.Mails.outbox')
                @else
                    @include('student.Mails.reply')
                @endif
            </div>
            <!--end::Inbox-->
        </div>
    ...
    <div class="modal modal-sticky modal-sticky-lg modal-sticky-bottom-right" id="kt_inbox_compose" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" @if(session('lang') == 'ar') style="direction: rtl" @endif>
                <!--begin::Form-->
                <form id="kt_inbox_compose_form" action="{{route('student.post.mail')}}" method="post">
                @csrf
                <!--begin::Header-->
                    ...
                    <div class="d-block">
                                ...
                                <select class="form-control" id="kt_select2_1"
                                    ...
                                    <optgroup label="{{trans('s_admin.admins')}}">
                                        @foreach(\App\Models\User::all() as $user)
                                            <option  value="admin,{{$user->id}}">{{$user->name}} </option>
                                        @endforeach
                                    </optgroup>
                        ...
                        <!--end::Subject-->
                        <!--begin::Message-->
                        <div id="kt_inbox_reply_editor" class="message-p border-0" style="height: 250px">
                        ...
                        <div class="d-flex align-items-center mr-3">
                            ...
                            <div class="btn-group mr-4">
                                <button id="send" type="button"
                                        class="btn btn-primary font-weight-bold px-6">{{trans('admin.send')}}</button>
                            </div>
                            <!--end::Send-->
                        </div>
                        <!--end::Actions-->
