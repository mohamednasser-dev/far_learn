            ...
            <div id="kt_header" class="header header-fixed"
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="topbar">
                        ...
                        <div class="dropdown">
                            @php
                                $notification_data = \App\Models\Notification::where('student_id',auth()->guard('student')->user()->id)->where('type','student')->where('message_type',"!=",'inbox')->where('readed','0')->orderBy('id','desc')->get();
                                $inboxes = \App\Models\Notification::where('student_id',auth()->guard('student')->user()->id)->where('readed','0')->where('message_type','inbox')->get();
                                $new_episodes = \App\Models\Episode_student::where('student_id',auth()->guard('student')->user()->id)->where('student_view','0')->get();
                                $total_new = count($notification_data) + count($new_episodes) + $inboxes->count();
                            @endphp
                ...
                <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                                                            ...
                                                            <div class="d-flex flex-column font-weight-bold">
                                                                <a href="{{route("student.inbox.reply",[$row->inbox_id])}}"
                        ...
                        <div class="topbar-item">
                            <div
                                ...
                                <span
                                    class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{auth::guard('student')->user()->first_name_ar}}</span>
