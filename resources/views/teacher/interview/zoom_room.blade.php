    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item">
                <a href="{{route('teacher.my_meetings')}}" class="text-muted">{{trans('s_admin.interviews')}}</a>
            </li>
        </ul>
    </div>
@endsection
        ...
        <div class="col-md-12">
            <div class="card card-custom p-12" >
                ...
                <div class="card-body py-0">
                    <iframe style="width: 100%;height: 870px;border: none;" src="{{route('teachers.zoom.interviews',$data->id)}}"></iframe>
                </div>
            </div>
        </div>
    </div>
