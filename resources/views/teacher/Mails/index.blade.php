    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                            ...
                            <div
                                ...
                                <div class="navi-item my-2">
                                    <a href="{{route('teacher.inbox.in')}}"
                                       class="navi-link @if(Route::current()->getName() == 'teacher.inbox.in' ) active @endif">
                                ...
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="{{route('teacher.inbox.out')}}"
                                       class="navi-link @if(Route::current()->getName() == 'teacher.inbox.out' ) active @endif">
															<span class="navi-icon mr-4">
																<span class="svg-icon svg-icon-lg">
                ...
                @if(Route::current()->getName() == 'teacher.inbox.in')
                    @include('teacher.Mails.inbox')
                @elseif(Route::current()->getName() == 'teacher.inbox.out')
                    @include('teacher.Mails.outbox')
                @else
                    @include('teacher.Mails.reply')
                @endif
            </div>
            <!--end::Inbox-->
        </div>
    ...
    <div class="modal modal-sticky modal-sticky-lg modal-sticky-bottom-right" id="kt_inbox_compose" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" @if(session('lang') == 'ar') style="direction: rtl" @endif>
                <!--begin::Form-->
                <form id="kt_inbox_compose_form" action="{{route('teacher.post.mail')}}" method="post">
                @csrf
                <!--begin::Header-->
