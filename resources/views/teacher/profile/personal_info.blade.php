        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-9 col-xl-6">
                    <h5 class="font-weight-bold mb-6">{{trans('s_admin.date_include_to_work')}}
                        : {{$data->created_at->format('Y-m-d')}}</h5>
                </div>
            </div>
            {{--                <div class="row">--}}
            {{--                    <label class="col-xl-3"></label>--}}
            ...
            <div class="form-group row">
                            ...
                            @else
                                <div class="image-input image-input-outline" id="kt_profile_avatar"
                                    ...
                                    <label
                                        ...
                                        data-original-title="{{trans('s_admin.choose_image')}}">
                                    ...
                                    <span
                                        class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                        data-action="cancel" data-toggle="tooltip" title="{{trans('s_admin.cancel')}}">
                                <i class="ki ki-bold-close icon-xs text-muted"></i>
                            </span>
                                    <span
                                        class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                        data-action="remove" data-toggle="tooltip"
                                        title="{{trans('s_admin.remove_image')}}">
                                <i class="ki ki-bold-close icon-xs text-muted"></i>
                            </span>
                                </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-7 col-xl-5">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" readonly value="{{$data->phone}}"
                                   class="form-control form-control-lg form-control-solid"/>
                        </div>
                    </div>
                    <div class="col-lg-2 col-xl-1">
                        <input id="txt_country_code" readonly class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            <input type="text" name="date_of_birth"
                                   value="{{Carbon\Carbon::parse($data->date_of_birth)->format('d-m-Y')}}"
                                   class="form-control form-control-lg form-control-solid hijri-date-input"/>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            <input required type="number" name="ident_num" value="{{$data->ident_num}}"
                                   class="form-control form-control-lg form-control-solid"/>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-7 col-xl-6">
                        <input required type="number" step="any" name="save_quran_num" min="0" max="30"
                               value="{{$data->save_quran_num}}"
                               class="form-control form-control-lg form-control-solid"/>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-7 col-xl-6">
                        <input required type="text" name="i_pan" value="{{$data->i_pan}}"
                               class="form-control form-control-lg form-control-solid"/>
                    </div>
                </div>
                <div class="form-group row">
