            ...
            <div class="symbol symbol-100 mr-5">
                ...
                @else
                    <div class="symbol-label"
                         style="background-image:url('{{auth::guard('teacher')->user()->image}}')"></div>
                ...
                <div class="navi mt-2">
                    <a href="javascript:void(0);" class="navi-item">
                                <span class="navi-link p-0 pb-2">
                                    ...
                                    <span
                                        class="navi-text text-muted text-hover-primary">{{auth::guard('teacher')->user()->email}}</span>
                                </span>
                    </a>
                    <a href="{{route('teacher_logout') }}"
                       class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">{{trans('admin.logout')}}</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
            ...
            <div class="offcanvas-footer row">
                ...
                <div class="col-md-3">
                    <a class="btn btn-secondary center"
                       href="{{route('teacher.change_colors.reset')}}">{{trans('s_admin.reset')}}</a>
                </div>
            </div>
        </form>
        <!--end::Purchase-->
