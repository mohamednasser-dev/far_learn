...
//                    'unique_name' => 'required|unique:teachers,unique_name|unique:students,unique_name|unique:users,unique_name',
                    ...
                    'first_name_ar' => 'required|max:191',
                    'mid_name_ar' => 'required|max:191',
                    'last_name_ar' => 'required|max:191',
                    'gender' => 'required',
                    'level_id' => 'required',
                    'subject_id' => '',
                    'subject_level_id' => '',
                    ...
                    'phone' => 'required|unique:students,phone|numeric|digits_between:9,10',
...
//                    'unique_name' => 'required',
                    ...
                    'country' => 'required',
                    'ident_num' => 'required|digits:10',
                    'phone' => 'required|numeric|digits_between:9,10|unique:students,phone,' . $id,
